...
/**
 * [Planet description]
 * @param {int} planetX [description]
 * @param {int} planetY [description]
 */
var Planet = function(planetX, planetY) {
	...
	if (planetX > 50 || planetY > 50 || planetX < 0 || planetY < 0 || typeof planetX === "undefined" || typeof planetY === "undefined") {
